...
<body>
    ...
    <table class="table table-striped">
        ...
        try {
            $sql = <<<SQL
            SELECT codigo, mensagem, dataHora,contato FROM interesse where codAnuncio = ? order by codigo
            SQL;
            ...
            try {
                ...
                while ($row) {
                    ...
                    echo "<td><a href='/controller/excluirInteresse.php?codigo=" . $row['codigo'] . "'>Excluir</a></td>";
                    echo "</tr>";
                $row = $stmt->fetch();
                }
            } 
